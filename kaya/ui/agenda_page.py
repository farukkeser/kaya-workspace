...
class MonthView(QtWidgets.QWidget):
    ...
    def __init__(self, afs: AgendaFS):
        ...
        self.bprev=QtWidgets.QToolButton(text="◄")
        self.bnext=QtWidgets.QToolButton(text="►")
        self.bthis=QtWidgets.QToolButton(text="This Month")   # ← eklendi
        ...
        t.addWidget(self.bprev); t.addSpacing(6); t.addWidget(self.title); t.addSpacing(6); t.addWidget(self.bnext)
        t.addSpacing(10); t.addWidget(self.bthis); t.addStretch(1)
        ...
        self.bthis.clicked.connect(self._goto_this_month)   # ← eklendi
        self.rebuild()
    ...
    def _goto_this_month(self):
        self.cur = date.today().replace(day=1)
        self.rebuild()
...
class DayView(QtWidgets.QWidget):
    ...
    def __init__(self, afs: AgendaFS):
        ...
        # toolbar (Month/Week butonları KALDIRILDI)
        tb=QtWidgets.QHBoxLayout()
        self.bprev=QtWidgets.QToolButton(text="◄")
        self.bnext=QtWidgets.QToolButton(text="►")
        self.btoday=QtWidgets.QToolButton(text="Today")
        for b in (self.bprev,self.bnext,self.btoday): b.setObjectName("navbtn")
        self.lbl=QtWidgets.QLabel()
